...
export const SOUND_PROFILES = [
  ...
  },
  {
    ...
    engine: {
      ...
      gears: [3.2, 2.0, 1.4, 1.05, 0.85],
      rpmCurve: 0.8,
      // S85-like rev envelope (smooth landings) — still lazy V8 redline
      revLo: 0.14,
      revHi: 0.48,
      revPull: 0.9,
    },
    tone: {
      // V8 harmonics kept; lope/pulse/sub pulled toward S85 smooth envelope
      // (high lope was continuous gain-LFO + uneven loop bake → "กระตุก")
      harmonics: [0, 1, 1.0, 0.35, 0.8, 0.25, 0.55, 0.18, 0.4, 0.12],
      body: 0.88,
      mid: 0.45,
      high: 0.28,
    ...
    dynamics: {
      ...
      overrunDuck: 0.94,
      floorBias: 1.0,
      gearScale: [0.96, 0.98, 1.0, 0.99, 0.97],
    },
  },
  {
    id: 's85-v10',
